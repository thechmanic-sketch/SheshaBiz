    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex flex-1 flex-col min-w-0">
        <header className="flex items-center justify-between border-b border-line bg-surface px-6 py-4">
          <div>
            <p className="text-sm text-ink-faint">{business.greeting}</p>
        ...
        <nav className="md:hidden sticky bottom-0 flex items-center justify-around border-t border-line bg-surface py-2">
